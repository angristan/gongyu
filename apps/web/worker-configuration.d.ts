/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7d031991ddd15b1127e8f0f2df5771f4)
// Runtime types generated with workerd@1.20260708.1 2026-07-15 global_fetch_strictly_public
interface __BaseEnv_Env {
	UPLOADS: R2Bucket;
	DB: D1Database;
	APP_ENV: "staging" | "local";
	RP_ID: "gongyu-cloudflare-staging.angristan.workers.dev" | "localhost";
	RP_ORIGIN: "https://gongyu-cloudflare-staging.angristan.workers.dev" | "http://localhost:5173";
	DATA_WORKFLOW: Workflow /* DataWorkflow from gongyu-cloudflare-staging-jobs */ | Workflow<Parameters<import("./workers/app").DataWorkflow['run']>[0]['payload']>;
	PHASE0_WORKFLOW: Workflow /* Phase0Workflow from gongyu-cloudflare-staging-jobs */ | Workflow<Parameters<import("./workers/app").Phase0Workflow['run']>[0]['payload']>;
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		RP_ORIGIN: "https://gongyu-cloudflare-staging.angristan.workers.dev";
		DATA_WORKFLOW: Workflow /* DataWorkflow from gongyu-cloudflare-staging-jobs */;
		PHASE0_WORKFLOW: Workflow /* Phase0Workflow from gongyu-cloudflare-staging-jobs */;
	}
