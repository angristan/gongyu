/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 193958d554591982a80604a9b4abc5a1)
...
interface __BaseEnv_Env {
	...
	PHASE0_WORKFLOW: Workflow<Parameters<import("./workers/app").Phase0Workflow['run']>[0]['payload']>;
}
