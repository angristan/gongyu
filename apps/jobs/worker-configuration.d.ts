/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 73d7c9bdd48809e9cae8de6e46962cdc)
...
interface __BaseEnv_Env {
	...
	DATA_WORKFLOW: Workflow<Parameters<import("./src/worker").DataWorkflow['run']>[0]['payload']>;
	PHASE0_WORKFLOW: Workflow<Parameters<import("./src/worker").Phase0Workflow['run']>[0]['payload']>;
